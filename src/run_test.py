...
#
DEFAULT_WANDB_PROJECT = "JSSP_Test"
FEATURE_TYPE_FOR_TESTS = "full"

EVALUATION_CAMPAIGNS: List[Dict[str, Any]] = [
    {
        "name": "convex_nonglob_full_short",
        "model_path": "models\\noG_convex_seed87_20260325-132517\\best_model\\best_model.zip",
        "test_dirs": [
            "TARS/src/test_data/6x6",
            "TARS/src/test_data/10x10",
            "TARS/src/test_data/15x15",
            "TARS/src/test_data/bench_data_txt/ABZ/10x10",
            "TARS/src/test_data/bench_data_txt/ABZ/20x15",
            "TARS/src/test_data/bench_data_txt/DMU/20x15",
            "TARS/src/test_data/bench_data_txt/DMU/20x20",
            "TARS/src/test_data/bench_data_txt/DMU/30x15",
            "TARS/src/test_data/bench_data_txt/DMU/30x20",
            "TARS/src/test_data/bench_data_txt/DMU/40x15",
            "TARS/src/test_data/bench_data_txt/DMU/40x20",
            "TARS/src/test_data/bench_data_txt/DMU/50x15",
            "TARS/src/test_data/bench_data_txt/DMU/50x20",
            "TARS/src/test_data/bench_data_txt/FT",
            "TARS/src/test_data/bench_data_txt/ORB",
            "TARS/src/test_data/bench_data_txt/SWV/20x10",
            "TARS/src/test_data/bench_data_txt/SWV/20x15",
            "TARS/src/test_data/bench_data_txt/SWV/50x10",
            "TARS/src/test_data/bench_data_txt/TA/15x15",
            "TARS/src/test_data/bench_data_txt/TA/20x15",
            "TARS/src/test_data/bench_data_txt/TA/20x20",
            "TARS/src/test_data/bench_data_txt/TA/30x15",
            "TARS/src/test_data/bench_data_txt/TA/30x20",
            "TARS/src/test_data/bench_data_txt/TA/50x15",
            "TARS/src/test_data/bench_data_txt/TA/50x20",
            "TARS/src/test_data/bench_data_txt/TA/100x20",
            "TARS/src/test_data/bench_data_txt/YN",
        ],
    },
